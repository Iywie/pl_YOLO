...
class SKFF(nn.Module):
    def __init__(self, in_channels, height=2, reduction=8, bias=False):
        ...
        d = max(int(in_channels / reduction), 6)
    ...
    def forward(self, inp_feats):
        ...
        height = len(inp_feats)

        inp_feats = torch.cat(inp_feats, dim=1)
        inp_feats = inp_feats.view(batch_size, height, n_feats, inp_feats.shape[2], inp_feats.shape[3])
        ...
        attention_vectors = attention_vectors.view(batch_size, height, n_feats, H, W)
